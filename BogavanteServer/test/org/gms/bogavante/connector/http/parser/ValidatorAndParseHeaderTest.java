...
public class ValidatorAndParseHeaderTest {
	...
	public void testParseCommaDelimitedList() {
		...
		String[] values = ValidatorAndParseHeader.parseCommaDelimitedList(field_value, false);
		assertThat("foo,bar",values, is(new String[]{"foo","bar"}));
		
		field_value = "foo ,bar,";
		values = ValidatorAndParseHeader.parseCommaDelimitedList(field_value, false);
		assertThat("foo ,bar,",values, is(new String[]{"foo","bar"}));
		...
		field_value = "";
		try{
			values = ValidatorAndParseHeader.parseCommaDelimitedList(field_value, true);
